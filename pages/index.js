  ...
  return (
    <>
      <nav className="nav">
        <div className="wrapper">
          <ul className="nav__links">
            {links.map((link) => {
              let ll = `/${link === "home" ? "" : link}`;
              return (
                <li className="links__link active" key={link}>
                  <Link href={ll}>{ll}</Link>
                </li>
              );
            })}
          </ul>
      ...
      <section className="hero">
        <div className="wrapper">
          <h1 style={{ display: "none" }}>Shivom Srivastava</h1>
          <svg
            width="596.5"
            height="72.001"
